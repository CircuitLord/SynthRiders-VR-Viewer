...
namespace NotSynth.IO { 
    ...
    public class Beats {
        ...
        /// </value>
        public Dictionary<float, List<SR_Note>> Easy { get; set; } 

        /// <value>
        /// Notes for the normal dificulty
        /// </value>
        public Dictionary<float, List<SR_Note>> Normal { get; set; } 

        /// <value>
        /// Notes for the hard dificulty
        /// </value>
        public Dictionary<float, List<SR_Note>> Hard { get; set; } 

        /// <value>
        /// Notes for the expert dificulty
        /// </value>
        public Dictionary<float, List<SR_Note>> Expert { get; set; } 

        /// <value>
        /// Notes for the Master dificulty
        /// </value>
        public Dictionary<float, List<SR_Note>> Master { get; set; } 

         /// <value>
        /// Notes for the Custom dificulty
        /// </value>
        public Dictionary<float, List<SR_Note>> Custom { get; set; } 
    }
    ...
    public class Crouchs {
        ...
        /// </value>
        public List<double> Easy { get; set; }
        ...
        /// </value>
        public List<double> Hard { get; set; }

        /// <value>
        /// Crouchs for the Expert dificulty
        /// </value>
        public List<double> Expert { get; set; }

        /// <value>
        /// Crouchs for the Master dificulty
        /// </value>
        public List<double> Master { get; set; }
